...
class HttpTest {
    ...
    private fun testServer(newsService: NewsRepo, f: suspend (HttpClient) -> Unit) = testApplication {
        application {
            configure()
...
private class NewsServiceMock : NewsRepo {
...
private class ErrorServiceMock : NewsRepo {
    override suspend fun getAllNews(): List<NewsDTO> {
